...
oltp_conn_string_local = "postgresql://postgres:admin@localhost:5432/oltp_digiskola"
warehouse_conn_string_local = "postgresql://postgres:admin@localhost:5432/dwh_digiskola"
...
dimension_columns = {
    ...
    "dim_product" : ["product_id","product_name","product_category_id","product_created","product_description","product_price","product_discount"],
